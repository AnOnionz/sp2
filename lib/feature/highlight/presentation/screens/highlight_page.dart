...
void initState() {
  ...
  _highlights = <HighlightEntity>[
    HighlightEntity(title: "Những vấn đề gặp phải của buổi làm việc", content: dataToday.highlightCached != null ? dataToday.highlightCached.workContent : "", images: dataToday.highlightCached != null ? dataToday.highlightCached.workImages.map((e) => File(e)).toList() : [], hint: "Không có chỗ đứng trong outlet, trời mưa nhiều nên không bán được hàng, vắng khách,…"),
